...
class SchoolActionView(APIView):
    ...
    Paths Available:
    - GET /school/school_list/ - List all schools (admin only)
    - GET /school/board_list/ - List all school boards (admin only)

    - POST /school/create/ - Create a new school (admin only)
    
    - PUT /school/update/ - Update an existing school (admin only)  
    """
    ...
    def put(self, request, action=None):
        ...
        if action == "update":
            ...
            return SchoolService().edit_school(request, school_id)
